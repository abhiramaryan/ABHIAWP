...
<body>
<?php
$connection =  mysqli_connect("localhost","root","","varun");
if($connection){
...
$query = "INSERT INTO student(name,email,phone,address,gender,DOB,password) VALUES('$name','$email','$phone','$address','$gender','$DOB','$password')";
